...
void ddsDacCalc()
{
	for(u8 i=0;i<4;i++)
	{
		...
		s32 interruptFreq = _framDatas.dacOutRate;
		s32 freq = _framDatas._ddsDacParam[i].freq;
		s32 duty = _framDatas._ddsDacParam[i].duty;
		s32 phase = _framDatas._ddsDacParam[i].phase;
